...
class TestNewsViews(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.news = self.newsfolder.get(self.newsfolder.invokeFactory('News', 'news', title="My News", image=image_))
        transaction.commit()
    ...
    def test_news_listing_view(self):
        ...
        self.assertIn('<img src="http://nohost/plone/newsfolder/news/@@images/', listing.get_img(brain))
