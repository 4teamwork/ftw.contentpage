...
class TestEventListing(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.eventfolder.invokeFactory('EventPage', 'event2', title="Event2",
                                       startDate=DateTime(2013, 05, 22, 10, 00),
